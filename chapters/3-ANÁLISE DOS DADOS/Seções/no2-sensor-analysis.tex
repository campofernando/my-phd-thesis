...
\begin{figure}[h!]
    ...
    \includegraphics[width=0.95\textwidth]{chapters/3-ANÁLISE DOS DADOS/Figuras/no2-B43F-models-performance.png}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\textwidth]{chapters/3-ANÁLISE DOS DADOS/Figuras/no2-T-KNN-Regression.png}
    ...
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\textwidth]{chapters/3-ANÁLISE DOS DADOS/Figuras/no2-T-RF-Regression.png}
