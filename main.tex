...
\titulo{Desenvolvimento de sistema de baixo custo para o monitoramento da qualidade do ar}
...
\coordenador[Coordenadora]{Profa. Alexandra Rodrigues Finotti, Dra.}
...
% 1 - Introdução
% ---
\include{chapters/0-INTRODUÇÃO/intro}
% ---

% ---
% 2 - Capítulo 1
% ---
\include{chapters/1-MONITORAMENTO/chapter-1}
% ---

% ---
% 2 - Capítulo 2
% ---
\include{chapters/2-CLEAN/clean-initiative}
% ---

% ---
% 3 - Capítulo 3
% ---
\include{chapters/3-ANÁLISE DOS DADOS/field-monitoring-results}
% ---

% ---
% 4 - Capítulo 4
% ---
\include{chapters/4-CALIBRAÇÃO MÚLTIPLOS SENSORES/regression-all-sensors}
% ---
...
% ---
\begin{apendicesenv}
    \input{aftertext/Operação sensores/operação_sensores_ec}
    \input{aftertext/Protótipos desenvolvidos/prototipos}
    \input{aftertext/Principais componentes de hardware/componentes_hardware}
    \input{aftertext/Firmware/descrição_fw}
	\input{aftertext/Firmware ESP8266/esp8266_fw.tex}
	\input{aftertext/Leituras SO2/so2-readings.tex}
\end{apendicesenv}
% ---
...
\begin{anexosenv}
%	\partanexos*
	\input{aftertext/Anexos/anexos.tex}
\end{anexosenv}
